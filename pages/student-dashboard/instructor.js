     ...
     <div className={styles.container}>
      ...
      <div className={styles.mainContent}>
        ...
        <div className={styles.instructorSection}>
          <h2 className={montserrat.className}>Instructor</h2>
          <div className={styles.instructorCard}>
            <div className={styles.instructorInfo}>
            <CircleEllipsis className={styles.ellipse} size={40}/>
           ...
           <div className={styles.instructorDetails}>
             <h2 className={montserrat.className}>Instructor Profile</h2>
            <p className={styles.instructorBio}>
                Emma Wilson is a product designer with over 5 years of experience designing digital products for startups and global technology companies. he specializes in creating user-centered experiences that solve real problems while aligning with business goals.            </p>
           </div>
            <div className={styles.metaItem}>
              <div className={styles.starContainer}>
                <Star className={styles.detailsIcon} size={20} />
                ...
                <Star className={styles.detailsIcon} size={20} />
                <Star className={styles.detailsIcon} size={20} />
                <span className={styles.hide}>(0)</span>
              </div>
               <span className={styles.close}>(0)</span>
               <Book className={styles.detailsIconBook} size={20} />
               <p className={styles.detailsCourse}>2 Courses</p>
               </div>
          </div>
        </div>
      ...
      <section className={styles.moreCourses}>
        <h2 className={montserrat.className}>More Courses By Instructor</h2>
        <p>Discover more educational courses to add to your knowledge</p>
