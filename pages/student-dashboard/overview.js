...
import { Search, Heart, Book, ShoppingCart, Bell, Clock5, Earth, GraduationCap, Lock, BookCheck, Star, CircleEllipsis } from 'lucide-react';
     ...
     <div className={styles.container}>
      ...
      <div className={styles.mainContent}>
        ...
        <div className={styles.overviewContainer}>
            <div className={styles.courseRequirement}>
                <h2 className={montserrat.className}>Course Requirements</h2>
                <p>A laptop or desktop computer<br/>Basic understanding of English<br/>Internet access</p>
            </div>
            <div className={styles.courseDescription}>
                <h2 className={montserrat.className}>Course Descriptions</h2>
                <p>This course introduces learners to the principles and practices of UI/UX and product design. Students will learn how to create user-centered digital experiences, from research and ideation to wireframing, prototyping, and visual design. The course emphasizes real-world design processes, tools, and methods used by professional designers to build engaging and intuitive products.</p>
            </div>
             <div className={styles.courseOutcome}>
            <h2 className={montserrat.className}>Course Outcomes</h2>
            <p>By the end of this course, students will be able to:
               Conduct user research and translate insights into design solutions
               Apply visual design principles to digital interfaces
               Test and iterate designs based on user feedback
               Develop cohesive design systems for scalable products
               Present professional case studies and build a portfolio</p>
         </div>
       <section className={styles.courseDetails}>
       <h2 className={montserrat.className}>Course Details</h2>
      <div className={styles.detailRow}>
        <span className={montserrat.className}>Level:</span>
      ...
      <div className={styles.detailRow}>
        <span>Learning Format:</span>
          <span>Video Lessons Practical exercises Peer or instructor feedback</span>
      </div>
    </section>
        </div>
