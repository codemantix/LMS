...
import { Search, Heart, ShoppingCart, Bell, Clock5, Earth, GraduationCap, Lock, BookCheck, Star, CircleEllipsis } from 'lucide-react';
      ...
      <div className={styles.mainContent}>
       <div className={styles.faqContainer}>
        <div className={styles.faq}>
         <h2 className={montserrat.className}>Leave a Question / a Comment</h2>
